...
class Evaluator:
    ...
    def check_segment_mismatch(self):
        ...
        try:
            ...
            logging.error(msg)
            print(data_format_pred)
            print(data_format_true)
    ...
    def evaluate(
        ...
        results = compute_precision_recall_wrapper(results)#  "P_micro","R_micro", and "F1_micro" are calculated here
        results = compute_macro_doc_scores(results)#"P_macro_doc", "R_macro_doc", "F1_macro_doc"
...
def compute_macro_doc_scores(results):
    ...
    for eval_schema in results:
        for metric in metrics:
            ...
            new_metric_name = metric+"_list"
            results[eval_schema][new_metric_name]=vals
            # if eval_schema in ["strict","ent_type"]:
            #     print(metric)
            #     print(vals)
