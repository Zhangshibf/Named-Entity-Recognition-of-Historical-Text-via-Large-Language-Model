...
@overload
def iscomplex(x: _ScalarLike_co) -> np.bool: ...  # type: ignore[tools]
@overload
def iscomplex(x: ArrayLike) -> NDArray[np.bool]: ...

@overload
def isreal(x: _ScalarLike_co) -> np.bool: ...  # type: ignore[tools]
@overload
...
@overload
def nan_to_num(  # type: ignore[tools]
    x: _SCT,
    copy: bool = ...,
    nan: float = ...,
    posinf: None | float = ...,
...
@overload
def real_if_close(  # type: ignore[tools]
...
@overload
def common_type(  # type: ignore[tools]
