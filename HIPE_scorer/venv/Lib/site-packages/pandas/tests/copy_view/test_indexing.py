...
@pytest.mark.parametrize(
    ...
    [
        ...
        lambda df: df[0:2].loc[:, "a":"b"],  # type: ignore[tools]
    ],
    ids=[
        "row-getitem-slice",
        "column-getitem",
...
@pytest.mark.parametrize(
    "method",
    [
        lambda s: s["a":"c"]["a":"b"],  # type: ignore[tools]
        lambda s: s.iloc[0:3].iloc[0:2],
        lambda s: s.loc["a":"c"].loc["a":"b"],  # type: ignore[tools]
        lambda s: s.loc["a":"c"]  # type: ignore[tools]
        .iloc[0:3]
        .iloc[0:2]
        .loc["a":"b"]  # type: ignore[tools]
        .iloc[0:1],
    ],
