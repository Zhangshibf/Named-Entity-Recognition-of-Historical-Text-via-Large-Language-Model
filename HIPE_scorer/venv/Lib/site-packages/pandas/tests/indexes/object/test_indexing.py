...
class TestSliceLocs:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (pd.IndexSlice["b":"y":-1], ""),  # type: ignore[tools]
            (pd.IndexSlice["b"::-1], "b"),  # type: ignore[tools]
            (pd.IndexSlice[:"b":-1], "yxdcb"),  # type: ignore[tools]
            (pd.IndexSlice[:"y":-1], "y"),  # type: ignore[tools]
            (pd.IndexSlice["y"::-1], "yxdcb"),  # type: ignore[tools]
            (pd.IndexSlice["y"::-4], "yb"),  # type: ignore[tools]
            # absent labels
            (pd.IndexSlice[:"a":-1], "yxdcb"),  # type: ignore[tools]
            (pd.IndexSlice[:"a":-2], "ydb"),  # type: ignore[tools]
            (pd.IndexSlice["z"::-1], "yxdcb"),  # type: ignore[tools]
            (pd.IndexSlice["z"::-3], "yc"),  # type: ignore[tools]
            (pd.IndexSlice["m"::-1], "dcb"),  # type: ignore[tools]
            (pd.IndexSlice[:"m":-1], "yx"),  # type: ignore[tools]
            (pd.IndexSlice["a":"a":-1], ""),  # type: ignore[tools]
            (pd.IndexSlice["z":"z":-1], ""),  # type: ignore[tools]
            (pd.IndexSlice["m":"m":-1], ""),  # type: ignore[tools]
        ],
    )
