...
class DatetimeIndexResamplerGroupby(  # type: ignore[tools]
...
class PeriodIndexResamplerGroupby(  # type: ignore[tools]
...
class TimedeltaIndexResamplerGroupby(  # type: ignore[tools]
